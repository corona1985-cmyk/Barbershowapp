...
import { ALLOW_IOS_ACCOUNT_CREATION, ALLOW_IOS_BARBER_SIGNUP, DEFAULT_PUBLIC_APP_URL } from '../config/app';
...
/** false en iOS cuando ALLOW_IOS_BARBER_SIGNUP está desactivado. */
export function isIOSBarberSignupAllowed(): boolean {
  return !isIOSPlatform() || ALLOW_IOS_BARBER_SIGNUP;
}
